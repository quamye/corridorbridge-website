...
export const metadata: Metadata = {
  title: "Nigeria ↔ Canada Corridor",
  description: "The Nigeria-Canada corridor connects Africa's largest economy with Canadian markets. A dynamic diaspora community, active fintech ecosystem, and significant bilateral trade make this one of the most active corridors.",
  keywords: "Nigeria Canada trade, Nigeria Canada payments, Nigeria ↔ Canada Corridor, cross-border Nigeria",
};

export default function CorridorPage() {
  const stats = [
    ["200M+", "Nigerian population"],
    ["NGN/CAD", "Primary currencies"],
    ["CBN Framework", "Regulatory oversight"],
    ["Active fintech", "Ecosystem support"],
  ];
  ...
  ].filter(([href]) => !href.includes("nigeria-canada"));

  const services = [
    { title: "Payment Infrastructure", desc: "Licensed partner selection, workflow design, and settlement tracking for Nigeria-Canada payments.", href: "/payments", icon: "💸" },
    { title: "Compliance Programme", desc: "FINTRAC, AML, KYC, and corridor-specific regulatory alignment for Nigeria-Canada operations.", href: "/compliance", icon: "🛡️" },
    { title: "Shipment Tracking", desc: "Real-time logistics visibility across Nigeria-Canada freight and trade shipments.", href: "/shipment-tracking", icon: "📦" },
      ...
      <section className="bg-blue-950 pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <h1 className="font-display text-5xl md:text-7xl font-bold text-white leading-[1.05] mb-4">
            <span style={{color: "#3b82f6"}}>Nigeria</span> ↔ Canada
          </h1>
          <h2 className="font-display text-2xl md:text-3xl font-semibold text-white/60 mb-6">Africa's Largest Economy Connected to Canada</h2>
          <p className="text-xl text-white/60 max-w-2xl leading-relaxed mb-10">The Nigeria-Canada corridor connects Africa's largest economy with Canadian markets. A dynamic diaspora community, active fintech ecosystem, and significant bilateral trade make this one of the most active corridors.</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-10 border-t border-white/10">
            {stats.map(([value, label]) => (
              <div key={label}>
                <div className="font-display text-2xl font-bold" style={{color: "#3b82f6"}}>{value}</div>
      ...
      <section className="py-24 bg-blue-950 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 text-lg max-w-xl mx-auto">End-to-end infrastructure for payments, compliance, logistics, and advisory on the Nigeria-Canada corridor.</p>
          </div>

...
export const metadata: Metadata = { title: "Africa ↔ Canada Corridor", description: "The primary trade and payment corridor between Africa and Canada — connecting businesses, governments, and financial institutions across the Atlantic.", keywords: "Africa Canada trade, Africa Canada payments, Africa Canada corridor, cross-border Africa Canada" };
    ...
    <>
      <section className="bg-blue-950 pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h1 className="font-display text-5xl md:text-6xl font-bold text-white mb-6">Africa ↔ Canada Corridor</h1>
          <p className="text-white/60 text-xl max-w-2xl">The primary trade and payment corridor between Africa and Canada — connecting businesses, governments, and financial institutions across the Atlantic.</p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {["Payments", "Compliance", "Logistics", "Advisory"].map(s => (
              <div key={s} className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-md hover:border-amber-200 transition-all">
                ...
                <h3 className="font-bold text-blue-950 text-lg mb-3">{s} for {"Africa ↔ Canada Corridor"}</h3>

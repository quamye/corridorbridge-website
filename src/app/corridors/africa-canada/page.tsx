...
export const metadata: Metadata = {
  title: "Africa ↔ Canada Corridor",
  description: "The Africa-Canada corridor connects one of the world's fastest-growing economic regions with one of its most stable, open trading nations. CorridorBridge is built specifically for this corridor.",
  keywords: "Africa Canada trade, Africa Canada payments, Africa ↔ Canada Corridor, cross-border Africa",
};

export default function CorridorPage() {
  const stats = [
    ["4B+", "Annual bilateral trade"],
    ["500K+", "African diaspora in Canada"],
    ["4", "Active payment lanes"],
  ...
  ].filter(([href]) => !href.includes("africa-canada"));

  const services = [
    { title: "Payment Infrastructure", desc: "Licensed partner selection, workflow design, and settlement tracking for Africa-Canada payments.", href: "/payments", icon: "💸" },
    { title: "Compliance Programme", desc: "FINTRAC, AML, KYC, and corridor-specific regulatory alignment for Africa-Canada operations.", href: "/compliance", icon: "🛡️" },
    { title: "Shipment Tracking", desc: "Real-time logistics visibility across Africa-Canada freight and trade shipments.", href: "/shipment-tracking", icon: "📦" },
    ...
    <>
      <section className="bg-blue-950 pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <h2 className="font-display text-2xl md:text-3xl font-semibold text-white/60 mb-6">The Primary Cross-Border Infrastructure Corridor</h2>
          <p className="text-xl text-white/60 max-w-2xl leading-relaxed mb-10">The Africa-Canada corridor connects one of the world's fastest-growing economic regions with one of its most stable, open trading nations. CorridorBridge is built specifically for this corridor.</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-10 border-t border-white/10">
            {stats.map(([value, label]) => (
              <div key={label}>
                <div className="font-display text-2xl font-bold" style={{color: "#C5A059"}}>{value}</div>
      ...
      <section className="py-24 bg-blue-950 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 text-lg max-w-xl mx-auto">End-to-end infrastructure for payments, compliance, logistics, and advisory on the Africa-Canada corridor.</p>
          </div>

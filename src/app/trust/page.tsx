...
export const metadata: Metadata = {
  title: "Trust Center — Security, Compliance & Privacy | CorridorBridge",
...
const TRUST_SECTIONS = [
  { id:"security", title:"Security", color:"#C5A059",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#C5A059" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>,
    items:[
  ...
  { id:"compliance", title:"Compliance", color:"#10b981",
  ...
  { id:"privacy", title:"Privacy", color:"#3b82f6",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>,
    items:[
  ...
  { id:"resilience", title:"Business Continuity", color:"#8b5cf6",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg>,
    items:[
  ...
  { id:"vendor", title:"Vendor Security", color:"#f59e0b",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#f59e0b" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>,
    items:[
  ...
  { id:"audit", title:"Audit Readiness", color:"#ef4444",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>,
    items:[
...
const PACKAGES = [
  {title:"Security Overview Package",desc:"Platform security architecture, controls summary, and security framework alignment overview for enterprise security reviews.",intent:"security_package",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#C5A059" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>},
  {title:"Compliance Overview Package",desc:"FINTRAC, AML, KYC, and regulatory compliance programme summary for compliance officer review.",intent:"compliance_package",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg>},
  {title:"Privacy Statement",desc:"PIPEDA-aligned privacy statement covering data collection, processing, retention, and your rights.",intent:"privacy_package",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>},
  {title:"Incident Response Summary",desc:"Summary of incident response programme, classification framework, and notification procedures.",intent:"incident_package",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg>},
  {title:"Vendor Security Overview",desc:"Third-party risk management programme overview for vendor risk assessment teams.",intent:"vendor_package",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#f59e0b" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>},
  {title:"Due Diligence Package",desc:"Comprehensive package combining security, compliance, privacy, and business continuity summaries for enterprise due diligence.",intent:"due_diligence_package",
    icon:<svg viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>},
];
    ...
    <>
      ...
      <section className="bg-blue-950 pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white leading-[1.05] mb-6 max-w-3xl">
            CorridorBridge<br/>
          ...
          <p className="text-xl text-white/60 max-w-2xl leading-relaxed mb-8">The primary resource for procurement teams, security reviewers, auditors, enterprise buyers, government agencies, banks, and investors evaluating CorridorBridge.</p>
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/contact?intent=due_diligence_package" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-sm bg-amber-500 text-blue-950 hover:bg-amber-400 hover:shadow-xl hover:-translate-y-0.5 transition-all">
              Request Due Diligence Package <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
            </Link>
            <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-sm border-2 border-white/30 text-white hover:border-amber-400 hover:text-amber-400 transition-all">Talk to Our Team</Link>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex gap-1 overflow-x-auto py-3">
            {TRUST_SECTIONS.map(({id,title,icon})=>(
              <a key={id} href={`#${id}`} className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold text-gray-600 hover:bg-gray-50 hover:text-blue-950 transition-all whitespace-nowrap flex-shrink-0">
          ...
          {TRUST_SECTIONS.map(({id,title,icon,color,items})=>(
            <div key={id} id={id} className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0" style={{background:`${color}15`}}>{icon}</div>
                <div>
                ...
                {items.map(({label,desc})=>(
                  <div key={label} className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-md hover:border-amber-200 transition-all">
                    <div className="flex items-center gap-2 mb-3">
                      <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-blue-950 mb-4">Request Security & Compliance Packages</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {PACKAGES.map(({title,desc,icon,intent})=>(
              <div key={title} className="bg-gray-50 border border-gray-200 rounded-2xl p-7 hover:shadow-lg hover:border-amber-200 hover:-translate-y-1 transition-all group">
                ...
                <Link href={`/contact?intent=${intent}`} className="inline-flex items-center gap-2 text-xs font-semibold text-amber-600 hover:text-amber-700 transition-colors group-hover:gap-3">
                  Request this package <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </Link>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white border border-gray-200 rounded-2xl p-8">
            <div className="flex items-start gap-3">
              <svg className="w-5 h-5 text-gray-400 flex-shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
              <div>
      ...
      <section className="py-20 bg-blue-950 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-white mb-4">Ready to complete your due diligence?</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-sm bg-amber-500 text-blue-950 hover:bg-amber-400 hover:shadow-xl transition-all">Request Due Diligence Package</Link>
            <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-sm border-2 border-white/30 text-white hover:border-amber-400 hover:text-amber-400 transition-all">Talk to Our Team</Link>
          </div>
        </div>
      </section>

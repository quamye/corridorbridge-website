...
export const metadata: Metadata = {
  ...
  description: "CorridorBridge cross-border infrastructure solutions for Fintech operating between Africa and Canada. Payments, compliance, logistics, and advisory.",
  keywords: "Fintech cross-border payments, Fintech Africa Canada, cross-border Fintech compliance",
};

export default function IndustryPage() {
  const benefits = ["Governance structuring and documentation", "Payment operating model review", "AML and KYC compliance framework", "Enterprise readiness advisory", "Regulatory alignment support"];
  const challenges = ["Enterprise clients demand governance documentation", "Regulatory scrutiny of cross-border payment models", "Operating model gaps limiting scalability", "Partner and vendor risk management immaturity", "Compliance credibility gaps in new markets"];
  ...
  ].filter(([href]) => !href.includes("fintech"));
    ...
    <>
      ...
      <section className="bg-blue-950 pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <h2 className="font-display text-2xl md:text-3xl font-semibold text-white/60 mb-6">Cross-Border Infrastructure for Financial Technology Companies</h2>
          <p className="text-xl text-white/60 max-w-2xl leading-relaxed mb-10">Fintechs expanding between Africa and Canada need governance, operating models, and compliance frameworks that satisfy enterprise clients and regulators on both sides of the corridor.</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <h2 className="font-display text-3xl font-bold text-blue-950 mb-6">Why Fintech Need Specialist Infrastructure</h2>
            ...
            <div>
              ...
              <h2 className="font-display text-3xl font-bold text-blue-950 mb-6">What We Deliver for Fintech</h2>
              <div className="space-y-3">
                {benefits.map((item) => (
      ...
      <section className="py-24 bg-blue-950 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-bold text-white mb-4">What We Offer Fintech</h2>
          </div>

...
export const metadata: Metadata = {
  ...
  description: "CorridorBridge cross-border infrastructure solutions for Logistics operating between Africa and Canada. Payments, compliance, logistics, and advisory.",
  keywords: "Logistics cross-border payments, Logistics Africa Canada, cross-border Logistics compliance",
};

export default function IndustryPage() {
  const benefits = ["Shipment tracking workflow design", "Payment-logistics integration advisory", "Customs compliance documentation framework", "Exception management process design", "Partner settlement workflow optimization"];
  const challenges = ["Fragmented systems disconnecting shipment and payment data", "Manual customs documentation causing delays", "Exception management handled manually", "Partner payment settlement complexity", "No unified visibility across corridors"];
  ...
  ].filter(([href]) => !href.includes("logistics"));
    ...
    <>
      ...
      <section className="bg-blue-950 pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <h2 className="font-display text-2xl md:text-3xl font-semibold text-white/60 mb-6">Cross-Border Infrastructure for Freight and Logistics Providers</h2>
          <p className="text-xl text-white/60 max-w-2xl leading-relaxed mb-10">Logistics companies managing Africa-Canada freight need operational infrastructure connecting shipment tracking, payment workflows, and compliance documentation in one system.</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <h2 className="font-display text-3xl font-bold text-blue-950 mb-6">Why Logistics Need Specialist Infrastructure</h2>
            ...
            <div>
              ...
              <h2 className="font-display text-3xl font-bold text-blue-950 mb-6">What We Deliver for Logistics</h2>
              <div className="space-y-3">
                {benefits.map((item) => (
      ...
      <section className="py-24 bg-blue-950 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-bold text-white mb-4">What We Offer Logistics</h2>
          </div>

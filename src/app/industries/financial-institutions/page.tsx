...
export const metadata: Metadata = {
  title: "Financial Institutions — Industry Solutions",
  description: "CorridorBridge cross-border infrastructure solutions for Financial Institutions operating between Africa and Canada. Payments, compliance, logistics, and advisory.",
  keywords: "Financial Institutions cross-border payments, Financial Institutions Africa Canada, cross-border Financial Institutions compliance",
};

export default function IndustryPage() {
  const benefits = ["Cross-border risk framework design", "AML and KYC programme advisory", "Trade finance governance and controls", "Correspondent banking risk management", "Regulatory alignment support"];
  const challenges = ["AML and KYC obligations for cross-border trade finance", "Correspondent banking risk management complexity", "Regulatory alignment across multiple jurisdictions", "Trade finance documentation and governance gaps", "FINTRAC reporting for institutional payments"];
  ...
  ].filter(([href]) => !href.includes("financial-institutions"));
      ...
      <section className="bg-blue-950 pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <h1 className="font-display text-5xl md:text-7xl font-bold text-white leading-[1.05] mb-4">
            <span style={{color: "#ef4444"}}>Financial Institutions</span>
          </h1>
          <h2 className="font-display text-2xl md:text-3xl font-semibold text-white/60 mb-6">Cross-Border Infrastructure for Banks and Financial Institutions</h2>
          <p className="text-xl text-white/60 max-w-2xl leading-relaxed mb-10">Banks and lenders supporting Africa-Canada trade need compliance, risk frameworks, and operational structures that meet regulatory expectations on both sides of the corridor.</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <h2 className="font-display text-3xl font-bold text-blue-950 mb-6">Why Financial Institutions Need Specialist Infrastructure</h2>
            ...
            <div>
              ...
              <h2 className="font-display text-3xl font-bold text-blue-950 mb-6">What We Deliver for Financial Institutions</h2>
              <div className="space-y-3">
                {benefits.map((item) => (
      ...
      <section className="py-24 bg-blue-950 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-bold text-white mb-4">What We Offer Financial Institutions</h2>
          </div>

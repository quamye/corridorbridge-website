...
export const metadata: Metadata = {
  ...
  description: "CorridorBridge cross-border infrastructure solutions for Government operating between Africa and Canada. Payments, compliance, logistics, and advisory.",
  keywords: "Government cross-border payments, Government Africa Canada, cross-border Government compliance",
};

export default function IndustryPage() {
  const benefits = ["Policy and governance advisory framework", "Regulatory alignment across corridors", "Vendor and supplier KYC assessment", "Institutional capacity building support", "Public sector payment governance"];
  const challenges = ["Cross-border regulatory coordination complexity", "Payment infrastructure governance gaps", "Policy documentation and compliance evidence needs", "Vendor and partner risk management requirements", "Audit and accountability obligations"];
  ...
  ].filter(([href]) => !href.includes("government"));
    ...
    <>
      ...
      <section className="bg-blue-950 pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <h2 className="font-display text-2xl md:text-3xl font-semibold text-white/60 mb-6">Cross-Border Infrastructure for Government Agencies</h2>
          <p className="text-xl text-white/60 max-w-2xl leading-relaxed mb-10">Government agencies managing cross-border regulatory obligations and development programmes need structured frameworks, documentation, and technology to support compliant trade operations.</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <h2 className="font-display text-3xl font-bold text-blue-950 mb-6">Why Government Need Specialist Infrastructure</h2>
            ...
            <div>
              ...
              <h2 className="font-display text-3xl font-bold text-blue-950 mb-6">What We Deliver for Government</h2>
              <div className="space-y-3">
                {benefits.map((item) => (
      ...
      <section className="py-24 bg-blue-950 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-bold text-white mb-4">What We Offer Government</h2>
          </div>

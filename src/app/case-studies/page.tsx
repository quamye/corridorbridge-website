...
export const metadata: Metadata = { title: "Case Studies", description: "CorridorBridge insights on cross-border payments, trade compliance, Africa-Canada logistics, and fintech advisory." };
    ...
    <>
      <section className="bg-blue-950 pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h1 className="font-display text-5xl font-bold text-white mb-4">Case Studies</h1>
